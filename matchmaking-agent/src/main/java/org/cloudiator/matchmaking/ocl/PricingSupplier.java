...
public class PricingSupplier implements Supplier<Map<Long, IaasEntities.Price>> {
    ...
    public PricingSupplier(String userId, String cloudAPIProviderName, PricingService pricingService) {
        this.userId = userId;
    ...
    public Map<Long, IaasEntities.Price> get() {
        ...
        try {
            List<IaasEntities.Price> prices = pricingService.getPrice(pricingQueryRequest).getPricesList();
